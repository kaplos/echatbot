...
export const exportToCSV = (products,type) => {
  ...
  function flattenDesignOnly(design) {
    return {
      ...
      metalType: design.startingInfo.metalType ?? "Gold",
      karat: design.startingInfo.karat ?? "10K",
      color: design.startingInfo.color ?? "Yellow",
  ...
  function flattenSampleOnly(sample) {
    ...
    s_status: sample.status ?? "Working_on_it:yellow",
      ...
      metalType: sample.startingInfo.metalType ?? "Gold",
      karat: sample.startingInfo.karat ?? "10K",
      color: sample.startingInfo.color ?? "Yellow",
